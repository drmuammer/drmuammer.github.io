---
title: "R'de açık WMS ile choropleth ve cartogram"
...
- **[GADM](https://gadm.org/)** — R'den tek satırda iner: `geodata::gadm("TUR", level = 1)`. Akademik kullanım ücretsiz.
- **[geoBoundaries](https://www.geoboundaries.org/)** — CC BY 4.0 lisansla yayımlanan açık kaynak. Yayın/tez/ticari kullanımda en az sürtünme.
...
GADM'in `NAME_1` sütunu ile kendi CSV'nin il adı her zaman birebir uyuşmaz: Afyonkarahisar/Afyon, Şanlıurfa/Urfa, Türkçe karakter farkı gibi tuzaklar var. Önce normalleştir:
